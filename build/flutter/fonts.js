...
function parseColorName(fullName) {
    var fullNameWithoutSize = fullName.split('-')[0].trim();
    return change_case_1.camelCase(fullNameWithoutSize.replace(/[ /%()+#,".]+/g, ''));
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            typographyProps = typographies
                .map(function (node) { return "  static const " + parseColorName(node.name) + " = " + formatFont(node) + ";"; })
                .join('\n  ');
