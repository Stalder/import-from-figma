...
function formatColor(color, opacity) {
    ...
    var dartColor = "Color(" + ("0xFF" + formatHex(r) + formatHex(g) + formatHex(b)) + ")";
...
function writeColors(colors) {
    return __awaiter(this, void 0, void 0, function () {
        var colorsProps, colorsContent;
        return __generator(this, function (_a) {
            colorsProps = colors
                .map(function (fill) {
                var name = parseColorName(fill.name);
                return "  static Color get " + name + " => const " + formatColor(fill.color, fill.opacity) + ";";
            })
                .join('\n\t');
            colorsContent = "// Generated by import-from-figma. Do not modify by hand\n\nimport 'dart:ui';\n\nclass FigmaColors {\n" + colorsProps + "\n}\n";
            resource_1.saveColors('figma_colors', colorsContent);
            return [2 /*return*/];
        });
    });
}
