...
function writeFonts(typographies) {
    return __awaiter(this, void 0, void 0, function () {
        var variablesText, content;
        return __generator(this, function (_a) {
            variablesText = typographies
                ...
                .map(function (node) {
                return "--font-" + node.name.toLocaleLowerCase().replace(/[ /%()+#,".]+/g, '-') + ": " + formatFont(node) + ";";
            })
                .join('\n\t');
            content = ":root { " + variablesText + " }";
            resource_1.saveFontsCss(content);
            return [2 /*return*/];
        });
    });
}
